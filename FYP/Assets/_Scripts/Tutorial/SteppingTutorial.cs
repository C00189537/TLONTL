...
public class SteppingTutorial : MonoBehaviour {


    public PlayerTutorial player;
    public TutorialWorld tutWorld;
    public StepTutorial stepManager; 
    ...
    void Start () {
        ...
        stepManager = GameObject.FindGameObjectWithTag("PlayerTut").GetComponent<StepTutorial>();
	...
	void Update () {
        ...
        if (stepManager.DestroyedSteps >= 28)
        {
            gameStart = false;
            gameEnd = true;
        }
    ...
    public IEnumerator End()
    {
        ...
        TutorialWorld.JumpPlatform = true;
